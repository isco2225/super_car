...
class _$AccountRegistrationCubitStateImpl
  ...
  @override
  String toString() {
    return 'AccountRegistrationCubitState(firstName: $firstName, lastName: $lastName, carName: $carName, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstName, lastName, carName, errorMessage);
